print "You enter a dark room with three doors. Do you go through door #1 or #2 or #3?"
...
if door == "3":
	...
	if money == "3":
			print "The money turns Iona into a million dollar company and they get robbed causing Father Bob to join Al Queda! Good Job!"